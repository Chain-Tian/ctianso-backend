...
public class PostEsDaoTest {
    ...
    void test() {
        ...
        com.baomidou.mybatisplus.extension.plugins.pagination.Page<Post> page = postService.searchFromEs(postQueryRequest);
    ...
    void testAdd() {
        ...
        postEsDTO.setId(1L);
        postEsDTO.setTitle("测试文章");
        postEsDTO.setContent("测试文章，第一个项目地址www.ctian-api.top");
    ...
    public void testFindByTitle() {
        List<PostEsDTO> list = postEsDao.findByTitle("测试文章");
