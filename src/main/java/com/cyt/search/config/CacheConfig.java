...
public class CacheConfig {
    ...
    @Bean
    public RedisCacheManager cacheManager5min(RedisConnectionFactory redisConnectionFactory) {

        RedisCacheConfiguration instanceConfig = instanceConfig(5 * 60L);//缓存时间1小时
